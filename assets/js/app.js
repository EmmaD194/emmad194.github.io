...
<img src="assets/images/bannernoback.png" href="index.html">
<!--<a class="navbar-brand" href="index.html">Emma's Web Design </a>-->
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="packages.html">Packages</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="previous-work.html">Previous Work</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="#contact">Contact</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="reviews.html">Reviews</a></li>
   <li class="nav-item">
...
let footer = $(`
<footer class="footer sticky-bottom"  id="contact" style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      
      <p class="tag" >If you have any queries or questions, please use this contact form and I will get back to you!</p>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
          <img src="assets/images/enoback.png" width="100%">
          </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/nDM4zwjk9t" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button linkedin" href="mailto:emmaruthdaly@gmail.com" target="_blank" >
    <!-- svg code for linkedin icon -->
      <svg class="linkedin-icon-footer" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 8 6" fill="#5addda"
    ...
    <a class="social-button instagram" href="https://www.instagram.com/emma_web_design/" target="_blank" >
    ...
    <a class="social-button linkedin" href="https://wa.me/00353851062188" target="_blank" >
    
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#3aa210" class="bi bi-whatsapp" viewBox="0 0 16 16">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/emma-daly-6a5a9519a/" target="_blank" >
    <!-- svg code for linkedin icon -->
